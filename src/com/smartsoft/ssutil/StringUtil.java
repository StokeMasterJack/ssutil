...
public class StringUtil {
    ...
    public static String chompLeadingComma(String input) {
    ...
    public static String rpad(String unpaddedString, int desiredFinalLength) {
        return rpad(unpaddedString, ' ', desiredFinalLength);
    }
    ...
    public static String lpad(int i, int desiredLength) {
        return lpad(i + "", ' ', desiredLength);
    }

    public static String lpad(String s, int desiredLength) {
        return lpad(s, ' ', desiredLength);
    }
